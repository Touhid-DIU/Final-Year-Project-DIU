        ...
        <div class="modal-body">
            <form>
              ...
              <div class="form-group">
                  ...
                  <input type="text" name="fieldsdate" class="form-control"  wire:model.defer="booking_date">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                  ...
                  <input type="text" name="fieldstime" class="form-control"  wire:model.defer="booking_time">
              </div>
              <div class="form-group">
