    ...
    <div class="container " style="margin-top: 10rem; margin-bottom:3rem;">
        <div class="row">
            <div class="col-md-8 offset-2 ">
             <div class="card">
               <h4 class="text-center p-4">Edit Product</h4>
                 <div class="card-body">
                   <div style="margin-left: 7.6rem;">
                     <a href="{{route('admin.dashboard')}}" class="btn btn-info my-3">All Product</a>
                   </div>
                   @if (Session::has('message'))
                   <div class="alert alert-success" role="alert">{{Session::get('message')}}</div>
                   @endif
                     <form wire:submit.prevent="updateproduct" id="upload-images"  enctype="multipart/form-data">
                         ...
                         <div class="form-group row">
                           ...
                           <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                              <input type="file" class="form-control-file" id="product_image"  wire:model="newimage">
                              @if ($newimage)
                                  <img src="{{$newimage->temporaryUrl()}}" width="120"/>
                              @else
                                <img src="{{asset('frontend/img/Books/products')}}/{{$image}}"  width="120"/>
                              @endif
                            </div>
                          </div>
                          <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                             ...
                             <button type="submit" class="btn btn-primary" style="margin-left: 7.7rem; margin-top:1rem;">Update</button>
                           </div>
                       </form>
                 </div>
               </div>
